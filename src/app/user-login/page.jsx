        ...
        AxiosInstance.post("user/login", data).then(
            async (response) => {
                if (response.data.success) {
                    ...
                    // console.log(params.get("ref"), "params.get(ref)")

                    if (params.get("ref") == "checkout") {
                        router.push("/checkout")
                        // router.push("/auth?ref=checkout");
                    ...
                    <form onSubmit={loginHandler} className="space-y-4">
                        <div>
                            ...
                            <input
                                type="email"
                                name="email"
                                className="w-full mt-1 px-3 py-2 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:bg-teal-700"
                        ...
                        <button
                            type="submit"
                            className="w-full py-2 bg-teal-600 text-white rounded-lg shadow hover:bg-teal-700 transition"
                        >
                            Sign In
                        </button>
                    </form>
